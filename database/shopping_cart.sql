...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2024 at 11:07 AM
...
(1, 'ปากกาลูกลื่น', 2, 'เหมาะสำหรับทุกการใช้งาน: ไม่ว่าจะเป็นการเขียนบันทึก การเซ็นเอกสาร หรือการจดบันทึกในที่ประชุม ปากกาลูกลื่นของเราตอบโจทย์ทุกการใช้งาน', '9996243120240824_181423.jpeg', 10, '0', 'ชิ้น', 10, '2021-06-26 16:38:28'),
(2, 'สมุดปกหนา', 1, 'สมุดปกหนา เหมาะสำหรับใช้ เขียนบันทึก ', '102974820120240824_181926.jpg', 20, '0', 'ชิ้น', 42, '2021-06-26 16:46:13'),
(3, 'ดินสอ 2B', 3, 'ดินสอดีต้องดินสอเรา', '179237916720241006_144816.jpeg', 7, '4', 'ชิ้น', 77, '2021-06-26 16:46:35'),
(4, 'ยางลบ', 4, 'ลบได้ ลบดี ลบหมด ยางลบKAB SHOP', '191280412220241006_144716.jpeg', 8, '2', 'ชิ้น', 47, '2021-06-26 16:46:51'),
(6, 'ปากกาลูกลื่น', 2, 'asdasd', '174513131220241006_144658.jpeg', 3, '5', 'ชิ้น', 15, '2024-09-14 10:12:28'),
(8, 'ทดสอบ', 1, 'ทอดสอบ', '177433984320241006_144637.png', 290, '1', 'ชิ้น', 32, '2024-09-30 16:16:10'),
(9, 'ทอดสอบ', 1, 'ทอดสอบ', '196341713420241006_144621.png', 250, '7', 'ชิ้น', 15, '2024-09-30 16:16:32'),
...
INSERT INTO `tb_order` (`orderID`, `cus_id`, `cus_name`, `address`, `telephone`, `total_price`, `order_status`, `reg_date`) VALUES
(0000000011, 0000000004, 'นายนำชัย ฮังกาสี2', 'กุก็เก่งเหมือนกันนะเนี้ย 55 ', '0120901', 34, '1', '2024-10-05 09:08:47'),
(0000000012, 0000000004, 'นายนำชัย ฮังกาสี2', 'กุก็เก่งเหมือนกันนะเนี้ย 55 ', '0120901', 20, '1', '2024-10-05 09:09:23'),
(0000000013, 0000000004, 'นายนำชัย ฮังกาสี2', 'กุก็เก่งเหมือนกันนะเนี้ย 55 ', '0120901', 60, '1', '2024-10-05 09:36:00'),
(0000000014, 0000000004, 'นายนำชัย ฮังกาสี2', 'กุก็เก่งเหมือนกันนะเนี้ย 55 ', '0120901', 2030, '1', '2024-10-05 11:25:59'),
...
--
ALTER TABLE `order_detail`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับที่', AUTO_INCREMENT=74;
...
--
ALTER TABLE `tb_order`
  MODIFY `orderID` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT 'เลขที่ใบสั่งซื้อ', AUTO_INCREMENT=18;
COMMIT;
