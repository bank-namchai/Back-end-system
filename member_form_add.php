...
<form  name="register" action="member_form_add_db.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6" align="left">
      <input  name="m_email" type="email" class="form-control" id="m_email" required  placeholder="ตัวอย่างเช่น name@hotmail.com"/>
    </div>
  </div>

  <div class="form-group">
    <div class="col-sm-3" align=""> Line id : </div>
    <div class="col-sm-6" align="left">
      <input  name="lineid" type="lineid" class="form-control" id="lineid"  placeholder="ถ้ามี"/>
    </div>
  </div>
